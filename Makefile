...
IMG ?= ghcr.io/fake-network-operator/fake-network-operator:0.1.0
...
.PHONY: all docker-build docker-push helm-lint helm-template helm-install helm-uninstall generate fmt vet test clean
